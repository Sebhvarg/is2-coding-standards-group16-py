...
<html>
   <head>
      <title>flake8 violations: .venv\Lib\site-packages\_pytest\config\compat.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages._pytest.config.compat.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages._pytest.config.compat.source.html#l64">
